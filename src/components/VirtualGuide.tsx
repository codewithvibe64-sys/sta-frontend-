      ...
      <AnimatePresence>
        ...
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-20 right-0 w-[300px] md:w-[340px] bg-[#131313] border border-[#1c1b1b] rounded-2xl shadow-[0_30px_70px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col"
          >
            {/* Header */}
